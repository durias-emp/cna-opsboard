    ...
    <div className="fixed inset-0 z-[120] flex flex-col justify-end"
      ...
      <div className="relative px-2.5 select-none"
        ...
        <div className="rounded-2xl overflow-hidden"
             style={{ background: 'rgba(37,37,40,0.60)', backdropFilter: 'blur(50px) saturate(210%)', WebkitBackdropFilter: 'blur(50px) saturate(210%)', border: '0.5px solid rgba(255,255,255,0.12)' }}>
          {title && (
        ...
        <button onClick={onClose}
          ...
          style={{ background: 'rgba(37,37,40,0.68)', backdropFilter: 'blur(50px) saturate(210%)', WebkitBackdropFilter: 'blur(50px) saturate(210%)', border: '0.5px solid rgba(255,255,255,0.12)' }}>
          Cancel
        </button>
      </div>
    </div>
