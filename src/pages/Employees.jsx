        ...
        right={(
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-full bg-white/[0.07]
                         text-xs font-semibold text-white/60 active:bg-white/[0.12] transition-colors select-none"
            >
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}
